 ...
 * 
 * @todo	write a method to check the validity of the rule
 */
class Oos_Generation_RewriteRule 
{
	/** string	Source of the rule */
	public $from;
	/** string	Destination of the rule */
	public $to;
	/** array	Flags for this rule */
	public $flags;
	 ...
	 */
	public function __construct($from, $to, $flags)
	{
		$this->from 	= $from;
		$this->to		= $to;
		$this->flags	= $flags;		
